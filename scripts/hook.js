...
//   deleteDirectory('./platforms/ios/intelwebrtc_ios/Plugins/owt.sample.conference.intelwebrtcplugin/OWT.framework');
    ...
    const outputDir_first_image = './platforms/ios/intelwebrtc_ios/Images.xcassets';
    ...
    request
      ...
      stat('./first.imageset.zip').then(stats => {
        ...
        console.log('finished unzip');
          ...
          getSize('./platforms/ios/intelwebrtc_ios/Images.xcassets/first.imageset', (err, size) => {
              if (err) { throw err; }
    ...
    const outputDir_second_image = './platforms/ios/intelwebrtc_ios/Images.xcassets';
    ...
    request
      ...
      .on('finish', function() {
        ...
        console.log('finished unzip');
          ...
          getSize('./platforms/ios/intelwebrtc_ios/Images.xcassets/second.imageset', (err, size) => {
              if (err) { throw err; }
